...
.pay-list .checkbox{
    background: url(~@/../static/images/checkbox_list.png) 0 -448rpx no-repeat;
...
.pay-list .icon-alipay{
    display: inline-block;
    vertical-align: middle;
    background-image: url(~@/../static/images/pay_methods.png);
...
.pay-list .icon-net{
    display: inline-block;
    vertical-align: middle;
    background: url(~@/../static/images/pay_methods.png) 0 -66.7rpx no-repeat;
    background-size: 56.25rpx 189.583rpx;
    margin-right: 10.5rpx;
    width: 56.25rpx;
    height: 56.25rpx;
