...
<view class="container">
  <view class="coupon-form">
    <view class="input-box">
      ...
      <image class="clear-icon" src="/static/images/clear_keyword.png"/>
    </view>
    <button class="add-btn disabled">兑换</button>
  </view>
  <view class="help">使用说明</view>
  <view class="coupon-list" v-for="(item, index) of couponList" :key="index">
    <view class="item">
      ...
      <view class="condition">
        ...
        <image src="/static/images/coupon_arrow.png" class="icon"/>
      </view>
    </view>
  </view>
</view>
...
.help{
  ...
  text-align: right;
  padding-right: 30rpx;
  background: url(~@/../static/images/coupon_help.png) 590rpx center no-repeat;
