...
<view class="container">
  ...
  <view class="no-cart" v-if="cartGoods.length <= 0">
    <view class="c">
      ...
      <image src="../../static/images/cart_no.png" />
      <text>去添加点什么吧</text>
    </view> 
  </view>
        ...
        <view class="goods">
          <view :class="isEditCart ? 'edit item' : 'item'" v-for="(item, index) of cartGoods" :key="item.id">
            ...
            <view class="cart-goods">
              <img class="img" :src="item.listPicUrl"/>
              <view class="info">
                <view class="t">
                  <text class="name">{{item.goodsName}}</text>
                  <text class="num">x{{item.num}}</text>
                </view>
                <view class="attr">{{ isEditCart ? '已选择:' : ''}}{{item.goodsSpecValue}}</view>
                <view class="b">
      ...
      <view class="group-item">
          ...
          <view class="goods">
              <view class="item">
                  ...
                  <view class="cart-goods">
                      <image class="img" src="../../static/images/quilt.png"/>
                      <view class="info">
                          <view class="t">
...
.cart-view .item .checkbox{
    ...
    background: url(~@/../static/images/checkbox_nochecked.png) no-repeat;
    background-size: 34rpx;
}

.cart-view .item .checkbox.checked{
    background: url(~@/../static/images/checkbox_checked.png) no-repeat;
    background-size: 34rpx;
}
...
.cart-view .item .open{
    ...
    display: block;
    float: right;
    background: url(~@/../static/images/arrow_down_cart.png) right center no-repeat;
...
.cart-view .item.edit .attr{
    text-align: right;
    background: url(~@/../static/images/arrow_right_cart.png) right center no-repeat;
    padding-right: 25rpx;
