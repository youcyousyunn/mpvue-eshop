...
<view class="container">
    <view class="brand-list" >
        <navigator
            ...
            <view class="img-bg">
                <img :src="item.appListPicUrl" background-size="cover"/>
            </view>
            <view class="txt-box">
                <view class="line">
...
export default {
  ...
  methods: {
    async getBrandList () {
      const res = await api.getBrandList({ currentPage: this.page, pageSize: this.size });
      if (res.rspCd === '00000') {
        // 品牌信息合并叠加
        this.brandList = this.brandList.concat(res.brandList);
        // 总页码
