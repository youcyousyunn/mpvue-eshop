...
<scroll-view class="container" style="height: 100%;">
  <view class="search-header">
    <view class="input-box">
      <image class="icon" src="../../static/images/keyword_search.png"/>
      ...
      <image class="del" v-if="keyword" @click="clearKeyword" src="../../static/images/search_clear.png"/>
    </view>
  ...
  <view class="no-search" v-if="!searchStatus">
    ...
    <view class="h">
      ...
      <image class="icon" @click="clearHistory" src="../../static/images/del_search.png"/>
    </view>
    <view class="b">
  ...
  <view class="search-result-empty" v-if="!goodsList.length && searchStatus">
    <image class="icon" src="../../static/images/search_noresult.png"/>
