...
.sort-box .item.by-price{
    background: url(~@/../static/images/icons_no.png) 155rpx center no-repeat;
    background-size: 15rpx 21rpx;
}

.sort-box .item.by-price.active.asc{
    background: url(~@/../static/images/icons_up.png) 155rpx center no-repeat;
    background-size: 15rpx 21rpx;
}

.sort-box .item.by-price.active.desc{
    background: url(~@/../static/images/icons_down.png) 155rpx center no-repeat;
    background-size: 15rpx 21rpx;
}
